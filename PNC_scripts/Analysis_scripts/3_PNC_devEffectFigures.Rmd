...
Make Figures 3A, 3E, 3I, 3M, 4A, 5A, 6A, and 6E 
Also makes Figure S2
...
### DevTraj Centered
#### load gam.smooths
- note that this chunk can take a few minutes to run as it takes a long time to load smooths
...
# note that this chunk can take a while to run as it takes a long time to load smooths
metric = "GBC"
...
#### Plot Figure 3A: GBC Dev Trajectory  
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTraj_PNC.pdf", dpi=1200, width = 5, height = 5)

devTraj.centered.GBC$glasser
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Supplementary/FigS2_GBCDevTraj_PNC.glasser.pdf", dpi=300, width = 5.5, height = 5)

devTraj.centered.GBC$gordon
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Supplementary/FigS2_GBCDevTraj_PNC.gordon.pdf", dpi=300, width = 5.5, height = 5)

devTraj.centered.GBC$schaefer400
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Supplementary/FigS2_GBCDevTraj_PNC.schaefer400.pdf", dpi=300, width = 5.5, height = 5)
```
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_SM_PNC.pdf", dpi=1200, width = 5, height = 5)

schaefer200x7_attention 
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_Attention_PNC.pdf", dpi=1200, width = 5, height = 5)

schaefer200x7_default 
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_Default_PNC.pdf", dpi=1200, width = 5, height = 5)
 
```

#### Make inset for Figure 3
...
inset_SomMot
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_inset.SomMot.pdf", dpi=300, width = 4, height = 4)

inset_Attention <- make_repParcel.inset("schaefer200x7", "attention", SA_rank=113, "#EEAC32FF", "schaefer7_200")
inset_Attention
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_inset.Attention.pdf", dpi=300, width = 4, height = 4)

inset_Default <- make_repParcel.inset("schaefer200x7", "default", SA_rank=155, "#C73000FF", "schaefer7_200")
inset_Default
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_inset.Default.pdf", dpi=300, width = 4, height = 4)
...
- note that this chunk may take a few minutes to run due to the spin tests
...
(GBC_glasser <- gam_figure_p.spin(GBC.axis_glasser, "GBC", "Glasser", r_text_GBC.glasser,
                                  x_pos= 250, y_pos=0.12, ylim_lower=-0.065, ylim_upper=0.15))
...
(GBC_schaefer400 <- gam_figure_p.spin(GBC.axis_schaefer400, "GBC", "Schaefer400", r_text_GBC.schaefer400, 
                                      x_pos= 320, y_pos=0.12, ylim_lower=-0.065, ylim_upper=0.15))
 
 
#BNC
 
r_text_BNC.gordon <- expression(paste(italic("r"), "= -0.70, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.66, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_WNC.gordon <- expression(paste(italic("r"), "= -0.43, ",  , italic(p[spin]), "< 0.05"))
(WNC_gordon <- gam_figure_p.spin(WNC.axis_gordon, "WNC", "Gordon", r_text_WNC.gordon, 
                                        x_pos= 250, y_pos=0.12, ylim_lower=-0.055, ylim_upper=0.17))

r_text_WNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.49, ",  , italic(p[spin]), "< 0.01"))
(WNC_schaefer200x7 <- gam_figure_p.spin(WNC.axis_schaefer200x7, "WNC", "schaefer200x7", r_text_WNC.schaefer200x7, 
                                        x_pos= 150, y_pos=0.1, ylim_lower=-0.055, ylim_upper=0.17))
...
r_text_WNC.schaefer400x7 <- expression(paste(italic("r"), "= -0.51, ",  , italic(p[spin]), "< 0.01"))
(WNC_schaefer400x7 <- gam_figure_p.spin(WNC.axis_schaefer400x7, "WNC", "schaefer400x7", r_text_WNC.schaefer400x7, 
                                        x_pos= 250, y_pos=0.1, ylim_lower=-0.055, ylim_upper=0.17))
...
GBC_schaefer200
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig4/Fig4_GBCAgeEffect_PNC.pdf", dpi=300, width = 5, height = 5)

GBC_glasser
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Supplementary/FigS2_GBCAgeEffect_PNC.glasser.pdf", dpi=300, width = 5, height = 5)

GBC_gordon
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Supplementary/FigS2_GBCAgeEffect_PNC.gordon.pdf", dpi=300, width = 5, height = 5)

GBC_schaefer400
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Supplementary/FigS2_GBCAgeEffect_PNC.schaefer400.pdf", dpi=300, width = 5, height = 5)
...
- gets the posterior fitted GBC correlations to SA axis. Can load output in following chunk. 
```{r load.edit_fits.SAaxis.posteriorcorrs, include=FALSE, eval=FALSE}

# load posterior fitted GBC correlations to SA-axis (fits.SAaxis.posteriorcorrs_metric$atlas)
...
saveRDS(cor.credible.intervals, "/cbica/projects/network_replication/output/PNC/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
...
#### Plot Figure 5A
- plotting absolute alignment with S-A axis
...
SA_metric_corr_GBC 
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig5/Fig5_PNC_GBC_ageFittedValues.pdf", dpi=1200, width = 5, height = 5)
```

## **Figure 6A**
#### Plot Figure 6A: BNC DevEffect  
...
BNC_schaefer200x7
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig6/Fig6_BNCAgeEffect_PNC.pdf", dpi=300, width = 6, height = 5)
```

## **Figure 6E**
#### Plot Figure 6E: WNC DevEffect  
...
WNC_schaefer200x7
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig6/Fig6_WNCAgeEffect_PNC.pdf", dpi=300, width = 6, height = 5)
```
