...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig4_New/Fig4_GBCAgeEffect_PNC.pdf", dpi=300, width = 5, height = 5)
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig5_New/Fig5_BNCAgeEffect_PNC.pdf", dpi=300, width = 6, height = 5)
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig5_New/Fig5_WNCAgeEffect_PNC.pdf", dpi=300, width = 6, height = 5)
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig4_GBCAgeEffect_PNC_Covbat.pdf", dpi=300, width = 5, height = 5)
```

##### Difference between Age Effect of BNC and WNC by S-A Axis
```{r BNC_WNC.fig, include=FALSE, eval=FALSE}

 
BNC.axis_schaefer200x7 <- BNC.axis_schaefer200x7 %>% rename(GAM.age.AdjRsq_BNC = GAM.age.AdjRsq)
WNC.axis_schaefer200x7 <- WNC.axis_schaefer200x7 %>% rename(GAM.age.AdjRsq_WNC = GAM.age.AdjRsq)

diff_WNC.BNC_df <- merge(select(BNC.axis_schaefer200x7, label, SA.axis_rank, GAM.age.AdjRsq_BNC), select(WNC.axis_schaefer200x7, label, GAM.age.AdjRsq_WNC), by = "label")
diff_WNC.BNC_df <- diff_WNC.BNC_df %>% mutate(WNC_BNC_diff = GAM.age.AdjRsq_WNC - GAM.age.AdjRsq_BNC)

cor.test(diff_WNC.BNC_df$WNC_BNC_diff, diff_WNC.BNC_df$SA.axis_rank)


(AgeEffect_figure <- ggplot(diff_WNC.BNC_df, aes(x=SA.axis_rank, y=WNC_BNC_diff, fill = SA.axis_rank)) + 
    geom_point(color = "gray", shape = 21, size=3.5) + 
    scale_fill_gradient2(low="#006CA5FF",high = "#A0CEB6FF", mid = "#009BA8FF", midpoint = median(diff_WNC.BNC_df$SA.axis_rank)) +
      labs(fill = "SA Axis Rank", x="S-A Axis Rank", y="Difference between WNC and BNC Age Effects") +
      ggtitle("PNC") + 
      geom_smooth(data = diff_WNC.BNC_df, method='lm', se=TRUE, fill=alpha(c("gray70"),.9), col="black") +
      theme(
    ...
    stat_cor(method = "spearman",size = 5, label.y.npc="top", label.x.npc = "center"))
```
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTraj_PNC.pdf", dpi=1200, width = 5, height = 5)


devTraj.centered.GBC$glasser
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Supplementary/FigS4_GBCDevTraj_PNC.glasser.pdf", dpi=300, width = 5.5, height = 5)

devTraj.centered.GBC$gordon
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Supplementary/FigS4_GBCDevTraj_PNC.gordon.pdf", dpi=300, width = 5.5, height = 5)

devTraj.centered.GBC$schaefer400
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Supplementary/FigS4_GBCDevTraj_PNC.schaefer400.pdf", dpi=300, width = 5.5, height = 5)
```

#### plot: BNC Dev Trajectory  
...
#### plot: GBC Dev Trajectory - by SA rank
...
#### plot: BNC Dev Trajectory - by SA rank
...
#### plot: WNC Dev Trajectory - by SA rank
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTrajRep_SM_PNC.pdf", dpi=1200, width = 5, height = 5)

schaefer200x7_attention$GBC
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTrajRep_Attention_PNC.pdf", dpi=1200, width = 5, height = 5)

schaefer200x7_default$GBC
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTrajRep_Default_PNC.pdf", dpi=1200, width = 5, height = 5)
...
```{r plot_inset, fig.height=3, fig.width=3}
 
inset_SomMot <- make_repParcel.inset("schaefer200x7", "SomMot", SA_rank=40, "#24A6A8FF", "schaefer7_200")
inset_SomMot
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig2/Fig2_GBCDevTrajRep_inset.SomMot.pdf", dpi=300, width = 4, height = 4)

inset_Attention <- make_repParcel.inset("schaefer200x7", "attention", SA_rank=113, "#EEAC32FF", "schaefer7_200")
inset_Attention
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig2/Fig2_GBCDevTrajRep_inset.Attention.pdf", dpi=300, width = 4, height = 4)

inset_Default <- make_repParcel.inset("schaefer200x7", "default", SA_rank=155, "#C73000FF", "schaefer7_200")
inset_Default
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig2/Fig2_GBCDevTrajRep_inset.Default.pdf", dpi=300, width = 4, height = 4)
...
for(row in c(1:nrow(schaefer200.parcel.labels))){ #for each schaefer region
  ...
  GAM.SMOOTH <- gam.smooth.predict(measure = "GBC", atlas = "schaefer200", dataset = "PNC", 
...
#write.csv(gam.smooths.schaefer,"/cbica/projects/network_replication/output/PNC/GBC/GBC_age_predictedfits_schaefer200.csv", row.names = F, quote = F) 
...
plot_fittedGBC_corr("schaefer200", "GBC", "PNC")
```
...
load_posterior_fits <- function(atlas_name, metric){
  ...
  assign(df_name, readRDS(sprintf("/cbica/projects/network_replication/output/%1$s/%2$s/GAM/SAaxis_posteriorfits_correlation_byage_%3$s.RData", dataset, metric, atlas_name)))
...
saveRDS(fits.SAaxis.posteriorcorrs_GBC, "/cbica/projects/network_replication/output/PNC/GBC/GAM/fits.SAaxis.posteriorcorrs_GBC.RData")
...
#saveRDS(fits.SAaxis.posteriorcorrs_BNC, "/cbica/projects/network_replication/output/PNC/BNC/GAM/fits.SAaxis.posteriorcorrs_BNC.RData")

#fits.SAaxis.posteriorcorrs_WNC <- lapply(atlases, load_posterior_deriv, "WNC")
#names(fits.SAaxis.posteriorcorrs_WNC) <- atlases 
#saveRDS(fits.SAaxis.posteriorcorrs_WNC, "/cbica/projects/network_replication/output/PNC/WNC/GAM/fits.SAaxis.posteriorcorrs_WNC.RData")
...
fits.SAaxis.posteriorcorrs_GBC <- readRDS("/cbica/projects/network_replication/output/PNC/GBC/GAM/fits.SAaxis.posteriorcorrs_GBC.RData") 

#fits.SAaxis.posteriorcorrs_BNC <- readRDS("/cbica/projects/network_replication/output/PNC/BNC/GAM/fits.SAaxis.posteriorcorrs_BNC.RData")  

#fits.SAaxis.posteriorcorrs_WNC <- readRDS("/cbica/projects/network_replication/output/PNC/WNC/GAM/fits.SAaxis.posteriorcorrs_WNC.RData" ) 
...
saveRDS(cor.credible.intervals_GBC, "/cbica/projects/network_replication/output/PNC/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
...
#saveRDS(cor.credible.intervals_BNC, "/cbica/projects/network_replication/output/PNC/BNC/GAM/cor.credible.intervals_BNC_fitted.RData")

 

#cor.credible.intervals_WNC <- lapply(atlases, function_cor.credible.intervals, "WNC")
#names(cor.credible.intervals_WNC) <- atlases
#saveRDS(cor.credible.intervals_WNC, "/cbica/projects/network_replication/output/PNC/WNC/GAM/cor.credible.intervals_WNC_fitted.RData")

```

 
```{r load_cor.credible.intervals, include=FALSE}
cor.credible.intervals_GBC <- readRDS("/cbica/projects/network_replication/output/PNC/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
 
#cor.credible.intervals_BNC <- readRDS("/cbica/projects/network_replication/output/PNC/BNC/GAM/cor.credible.intervals_BNC.fitted.RData")

#cor.credible.intervals_WNC <- readRDS("/cbica/projects/network_replication/output/PNC/WNC/GAM/cor.credible.intervals_WNC.fitted.RData")
...
#### plot: Temporal sliding window correlation analysis - GBC
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig7/Fig7_PNC_GBC_ageFittedValues.pdf", dpi=300, width = 6, height = 5)
...
#### plot: Magnitude and Direction of Developmental Change - GBC
...
#### plot: Magnitude and Direction of Developmental Change - BNC
...
#### plot: Magnitude and Direction of Developmental Change - WNC
...
SA_metric_corr_GBC$schaefer200
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/TempSlidingWindow_textOnly/PNC_slidingWindow_GBC.png", dpi=300, width = 4, height = 4)
...
#### plot: Temporal sliding window correlation analysis - BNC
...
#### plot: Temporal sliding window correlation analysis - WNC
