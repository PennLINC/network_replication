...
r_text_BNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.66, ",  , italic(p[spin]), "< 0.001"))
...
r_text_WNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.49, ",  , italic(p[spin]), "< 0.001"))
...
r_text_WNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.44, ",  , italic(p[spin]), "< 0.01"))
(WNC_schaefer200x17 <- gam_figure_p.spin(WNC.axis_schaefer200x17, "WNC", "schaefer200x17", r_text_WNC.schaefer200x17, 
                                        x_pos= 150, y_pos=0.1, ylim_lower=-0.055, ylim_upper=0.17))

r_text_WNC.schaefer400x7 <- expression(paste(italic("r"), "= -0.51, ",  , italic(p[spin]), "< 0.001"))
...
cor.credible.intervals <- readRDS("/cbica/projects/network_replication/output/PNC/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
```
