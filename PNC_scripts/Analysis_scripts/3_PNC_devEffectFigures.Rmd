...
Make Figures 2A, 2E, 2I, 2M, 4A, 5A, and 5E 
Also makes Supp Fig 2
...
#### Plot Figure 2A: GBC Dev Trajectory  
...
## **Supp Fig 2**
#### load gam results (relevant for Fig 5 too)
...
#### Plot Supp Fig 2: GBC DevEffect 
```{r Fig1, fig.height= 8, fig.width= 16, warning=FALSE, cache=TRUE}

plot_grid(GBC_glasser, GBC_gordon, GBC_schaefer400, labels = "AUTO")
...
## **Figure 5A**
#### Plot Figure 5A: BNC DevEffect  
```{r Fig5a, fig.height= 8, fig.width= 16, warning=FALSE, cache=TRUE}
  
BNC_schaefer200x7 
```

## **Figure 5E**
#### Plot Figure 5E: WNC DevEffect  
```{r Fig5e, fig.height= 8, fig.width= 16, warning=FALSE, cache=TRUE}
