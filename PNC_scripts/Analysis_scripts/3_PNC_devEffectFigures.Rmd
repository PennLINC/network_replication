...
for(i in c(1:length(atlases))){
  ...
  assign(gam.edge.age, readRDS(sprintf("/cbica/projects/network_replication/output/%1$s/%2$s/GAM/GAMresults.%2$s.age.%3$s.RData", dataset, "edge", atlases[i])))
...
edge_gam <- readRDS(sprintf("/cbica/projects/network_replication/output/%1$s/%2$s/GAM/GAMresults.%2$s.age.%3$s.RData", dataset, "edge", atlases[i]))
...
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig6_New/Fig6_EdgeSurfacePlot_PNC.pdf", dpi=300, width = 5, height = 5)
