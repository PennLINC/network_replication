...
demographics <- read.csv("/cbica/projects/network_replication/input/PNC/sample_selection/PNC_demographics_finalsample_restOnly_20230103.csv")
...
GBC.glasser.PNC <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/GBC/GBCglasser_demographics_finalsample.csv", dataset))
GBC.gordon.PNC <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/GBC/GBCgordon_demographics_finalsample.csv", dataset)) 
...
GBC.schaefer400.PNC <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/GBC/GBCschaefer400_demographics_finalsample.csv", dataset)) 
names(GBC.schaefer400.PNC) <- gsub('X17Networks', "Networks", names(GBC.schaefer400.PNC)) 
 
 
# BNC
BNC.gordon.PNC <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/BNC/BNCgordon_demographics_finalsample.csv", dataset))   
BNC.schaefer200x7.PNC <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/BNC/BNCschaefer200x7_demographics_finalsample.csv", dataset)) 
names(BNC.schaefer200x7.PNC) <- gsub("X7", "", names(BNC.schaefer200x7.PNC))

BNC.schaefer200x17.PNC <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/BNC/BNCschaefer200x17_demographics_finalsample.csv", dataset))    
