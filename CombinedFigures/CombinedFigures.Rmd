---
title: "Figures using all datasets together"
author: "Audrey Luo"
date: "2023-02-14"
...
ageEffect_surf.fig <- function(dataset_name){
  surf.fig <- ggplot() + geom_brain(data=get(dataset_name), 
      ...
      scale_fill_gradientn(colors= c("#009DA1FF", "#FFFFFF","#D94602FF"), limits = c(-0.05,0.15),  oob=squish,
...
ageEffect_surf_NKI
g#gsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig2/Fig2_ageSurface_NKI.pdf", dpi=1200, width = 5, height = 5)
...
make_surface_plot_datasets <- function(dataset) {
  ...
  surface.plot.fig <- gg_tensor(g2)+theme_classic() +
   ...
   scale_fill_gradientn(colors= c("#009DA1FF", "#FFFFFF","#D94602FF"), limits = c(-0.011,0.019), oob=squish, 
...
#surfacePlot_PNC
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig6_New/colorbar.pdf", dpi=1200, width = 5, height = 5)

surfacePlot_PNC
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig6_New/Fig6_EdgeSurfacePlot_PNC.pdf", dpi=1200, width = 5, height = 5)

surfacePlot_NKI
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig6_New/Fig6_EdgeSurfacePlot_NKI.pdf", dpi=1200, width = 5, height = 5)

surfacePlot_HCPD
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig6_New/Fig6_EdgeSurfacePlot_HCPD.pdf", dpi=1200, width = 5, height = 5)

surfacePlot_HBN
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig6_New/Fig6_EdgeSurfacePlot_HBN.pdf", dpi=1200, width = 5, height = 5)
...
# Plot the predicted GBC for each parcel at age 8, 12, 20 in PNC
```{r}
  ...
  fitted_df <- get(paste0("fitted_df_", dataset_name))
    ...
    ageMap.fig <- ggplot() + geom_brain(data=fitted_df[c(which(fitted_df$age==age_map)),], 
       ...
       paletteer::scale_fill_paletteer_c("grDevices::RdYlBu", limits = c(-0.05,0.12), oob=scales::squish, 
                           values=rescale(c(-0.05,0.04,0.12))) + 
...
age8_PNC_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age8_PNC.pdf", dpi=1200, width = 5, height = 5)

age14_PNC_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age14_PNC.pdf", dpi=1200, width = 5, height = 5)

age22_PNC_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age22_PNC.pdf", dpi=1200, width = 5, height = 5)
 
 


age8_NKI_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age8_NKI.pdf", dpi=1200, width = 5, height = 5)

age14_NKI_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age14_NKI.pdf", dpi=1200, width = 5, height = 5)

age22_NKI_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age22_NKI.pdf", dpi=1200, width = 5, height = 5)




age8_HCPD_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age8_HCPD.pdf", dpi=1200, width = 5, height = 5)

age14_HCPD_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age14_HCPD.pdf", dpi=1200, width = 5, height = 5)

age22_HCPD_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age22_HCPD.pdf", dpi=1200, width = 5, height = 5)

age8_HBN_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age8_HBN.pdf", dpi=1200, width = 5, height = 5)

age14_HBN_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age14_HBN.pdf", dpi=1200, width = 5, height = 5)

age22_HBN_fig
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/FittedGBC_Age22_HBN.pdf", dpi=1200, width = 5, height = 5)
...
# make gganimate version TEEHEEHEE!!
 
```{r}
library(gganimate)
(fitted_map <- ggplot() + geom_brain(data=fitted_df, 
                                            atlas=schaefer17_200, 
                                            mapping=aes(fill=fitted), 
                                            show.legend=TRUE, 
                                            position = position_brain(hemi ~ side)) + 
       paletteer::scale_fill_paletteer_c("grDevices::RdYlBu", limits = c(min(fitted_df$fitted),max(fitted_df$fitted)), 
                           values=rescale(c(min(fitted_df$fitted),median(fitted_df$fitted),max(fitted_df$fitted)),  oob=squish)) + theme_void())

 
unique(fitted_df$age)

fitted_map_SO.COOL <- fitted_map + transition_states(age, transition_length = 1, state_length = 1, wrap = TRUE)  +
  labs(title = "Age: {closest_state}") + theme(plot.title = element_text(size = 40, face = "bold", hjust=0.5), legend.position = "none")
 
  
mygif <- animate(fitted_map_SO.COOL, width=1600, height=800, fps=40, renderer=gifski_renderer(loop=TRUE))

anim_save(filename="/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/fitted_map.gif", mygif)
```
...
# Plot the intercept across all parcels (in PNC)
```{r}
...
gam.GBC.age.glasser <- fitGAMs_intercept(glasser.parcel.labels, "GBC", "glasser", "",dataset)
gam.GBC.age.gordon <- fitGAMs_intercept(gordon.parcel.labels, "GBC", "gordon", "", dataset)
gam.GBC.age.schaefer200 <- fitGAMs_intercept(schaefer200x17.parcel.labels, "GBC", "schaefer200", "", dataset)
gam.GBC.age.schaefer400 <- fitGAMs_intercept(schaefer400x17.parcel.labels, "GBC", "schaefer400", "", dataset)
 
 

#gam.GBC.age.schaefer200 <- gam.GBC.age.schaefer200 %>% mutate(SA.axis_rank_signif = ifelse(significant.fdr == 1, SA.axis_rank, NA))
gam.GBC.age.schaefer200$region <- gam.GBC.age.schaefer200$label
gam.GBC.age.schaefer200$region <- gsub("Network", "17Network", gam.GBC.age.schaefer200$region)
gam.GBC.age.schaefer200_PNC <- bind_cols(gam.GBC.age.schaefer200$region, gam.GBC.age.schaefer200$Intercept)
names(gam.GBC.age.schaefer200_PNC) <- c("region", "Intercept")
 
 

# PNC
(Intercept_surf_PNC <- ggplot() + geom_brain(data=gam.GBC.age.schaefer200_PNC, 
                                            atlas=schaefer17_200, 
                                            mapping=aes(fill=Intercept), 
                                            show.legend=TRUE, 
                                            position = position_brain(c("right medial", "right lateral"))) + 
      scale_fill_gradientn(colors= c("#009DA1FF", "#FFFFFF","#D94602FF")) +
      theme_void())

```


# Looking at average GBC in youngest and oldest participants
```{r}

make_youngest_oldest <- function(dataset) { # only for schaefer200 and GBC. Get bottom and top 15% youngest and oldest participants
  if(dataset=="PNC" | dataset=="NKI") {
  ...
  ordered_GBC.schaefer200 <- GBC.schaefer200 %>% arrange(age)
  
  bottom_15 <- round(nrow(GBC.schaefer200)*0.15)
  youngest <- ordered_GBC.schaefer200[c(1:bottom_15),]
  youngest_meanGBC <- colMeans(youngest[,c(which(str_detect(names(youngest), "Networks")))])
 
  region <- names(youngest_meanGBC)
  youngest_mapDf <- bind_cols(region, youngest_meanGBC)
  names(youngest_mapDf) <- c('region', 'mean_GBC')
   
  top_15 <- nrow(GBC.schaefer200) - bottom_15
  oldest <- ordered_GBC.schaefer200[c(top_15:nrow(GBC.schaefer200)),]
   
  oldest_meanGBC <- colMeans(oldest[,c(which(str_detect(names(oldest), "Networks")))])
  region <- names(oldest_meanGBC)
  oldest_mapDf <- bind_cols(region, oldest_meanGBC)
  names(oldest_mapDf) <- c('region', 'mean_GBC')
  
   
  youngest_mapDf$region <- gsub("Network", "17Network", youngest_mapDf$region)
  oldest_mapDf$region <- gsub("Network", "17Network", oldest_mapDf$region)
   
  youngest_oldest <- list(youngest_mapDf, oldest_mapDf)
   
  print(range(youngest_mapDf$mean_GBC))
  print(range(oldest_mapDf$mean_GBC))
  return(youngest_oldest)
}


youngOld_map_fig <- function(youngest_oldest_df, dataset) {
  youngestMap <- ggplot() + geom_brain(data=youngest_oldest_df[[1]], 
                                            atlas=schaefer17_200, 
                                            mapping=aes(fill=mean_GBC), 
                                            show.legend=TRUE, 
                                            position = position_brain(c("right medial", "right lateral"))) + 
      scale_fill_gradientn(colors= c("#009DA1FF", "#FFFFFF","#D94602FF"), limits = c(min(youngest_oldest_df[[2]]$mean_GBC)-0.008,max(youngest_oldest_df[[2]]$mean_GBC)+0.015), 
                           values=rescale(c(min(youngest_oldest_df[[2]]$mean_GBC)-0.008,0,max(youngest_oldest_df[[2]]$mean_GBC)+0.015), oob=squish)) + ggtitle(paste("Youngest 15% in", dataset)) + 
      theme_void()

 oldestMap <- ggplot() + geom_brain(data=youngest_oldest_df[[2]], 
                                            atlas=schaefer17_200, 
                                            mapping=aes(fill=mean_GBC), 
                                            show.legend=TRUE, 
                                            position = position_brain(c("right medial", "right lateral"))) + 
      scale_fill_gradientn(colors= c("#009DA1FF", "#FFFFFF","#D94602FF"), limits = c(min(youngest_oldest_df[[2]]$mean_GBC)-0.008,max(youngest_oldest_df[[2]]$mean_GBC)+0.015), 
                           values=rescale(c(min(youngest_oldest_df[[2]]$mean_GBC)-0.008,0,max(youngest_oldest_df[[2]]$mean_GBC)+0.015), oob=squish)) + ggtitle(paste("Oldest 15% in", dataset)) + 
      theme_void()
 mapFig <- list(youngestMap, oldestMap)
  return(mapFig)
}
...
# PNC
PNC_youngest_oldest <- make_youngest_oldest("PNC")
PNC_mapFig <-  youngOld_map_fig(PNC_youngest_oldest, "PNC")

# NKI
NKI_youngest_oldest <- make_youngest_oldest("NKI")
NKI_mapFig <-  youngOld_map_fig(NKI_youngest_oldest, "NKI")

# HCPD
HCPD_youngest_oldest <- make_youngest_oldest("HCPD")
HCPD_mapFig <-  youngOld_map_fig(HCPD_youngest_oldest, "HCPD")

# HBN
HBN_youngest_oldest <- make_youngest_oldest("HBN")
HBN_mapFig <-  youngOld_map_fig(HBN_youngest_oldest, "HBN")
...
cor.test(schaefer200x17_SAaxis$SA.axis_rank, PNC_youngest_oldest[[1]]$mean_GBC, method="spearman")
cor.test(schaefer200x17_SAaxis$SA.axis_rank, PNC_youngest_oldest[[2]]$mean_GBC, method="spearman")


cor.test(schaefer200x17_SAaxis$SA.axis_rank, NKI_youngest_oldest[[1]]$mean_GBC, method="spearman")
cor.test(schaefer200x17_SAaxis$SA.axis_rank, NKI_youngest_oldest[[2]]$mean_GBC, method="spearman")



cor.test(schaefer200x17_SAaxis$SA.axis_rank, HCPD_youngest_oldest[[1]]$mean_GBC, method="spearman")
cor.test(schaefer200x17_SAaxis$SA.axis_rank, HCPD_youngest_oldest[[2]]$mean_GBC, method="spearman")


cor.test(schaefer200x17_SAaxis$SA.axis_rank, HBN_youngest_oldest[[1]]$mean_GBC, method="spearman")
cor.test(schaefer200x17_SAaxis$SA.axis_rank, HBN_youngest_oldest[[2]]$mean_GBC, method="spearman")
