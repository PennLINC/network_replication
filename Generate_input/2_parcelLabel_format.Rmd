...
schaefer200x7_coords <- read.csv("/cbica/projects/network_replication/software/rotate_parcellation/schaefer200x7_sphericalcoords.csv", header=TRUE)
schaefer200x7_coords_reordered <-schaefer200x7_coords[index_schaefer200x7to17$V1,]
schaefer200x7_coords_reordered <- schaefer200x7_coords_reordered %>% dplyr::rename(ROI.Name=label)
write.csv(schaefer200x7_coords_reordered, "/cbica/projects/network_replication/software/rotate_parcellation/schaefer200x7_sphericalcoords_reordered.csv") # note that 7 network parcels had to be reordered to 17 network ordering because the pconn files are all 17 network
...
# reorder spherical coordinates
schaefer400x7_coords <- read.csv("/cbica/projects/network_replication/software/rotate_parcellation/schaefer400x7_sphericalcoords.csv", header=TRUE)
schaefer400x7_coords_reordered <-schaefer400x7_coords[index_schaefer400x7to17$V1,]
schaefer400x7_coords_reordered <- schaefer400x7_coords_reordered %>% dplyr::rename(ROI.Name=label)
write.csv(schaefer400x7_coords_reordered, "/cbica/projects/network_replication/software/rotate_parcellation/schaefer400x7_sphericalcoords_reordered.csv") 
```
