...
Makes Figures 2B, 2F, 2J, 2N, 4B, 5B, 5F
...
#### Plot Figure 2B: GBC Dev Trajectory  
...
saveRDS(list(p_spin_BNC, p_spin_WNC), "/cbica/projects/network_replication/output/NKI/pspin_vals.RData")
```
...
r_text_BNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.50, ",  , italic(p[spin]), "< 0.001"))
...
#### Plot Figure 5B: BNC DevEffect  
```{r Fig5b, fig.height= 8, fig.width= 16, warning=FALSE, cache=TRUE}
BNC_schaefer200x7  
```


#### Plot Figure 5F: WNC DevEffect  
```{r Fig5f, fig.height= 8, fig.width= 16, warning=FALSE, cache=TRUE}
WNC_schaefer200x7  
```
