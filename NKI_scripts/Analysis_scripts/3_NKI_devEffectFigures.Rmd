...
r_text_GBC.schaefer400 <- expression(paste(italic("r"), "= -0.54, ",  , italic(p[spin]), "< 0.001"))
...
r_text_BNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.56, ",  , italic(p[spin]), "< 0.0001"))
