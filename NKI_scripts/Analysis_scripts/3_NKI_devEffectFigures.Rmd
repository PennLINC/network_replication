...
r_text_WNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.13, ",  , italic(p[spin]), "= N.S."))
...
BNC_schaefer200x7 
save_plot("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig6/Fig6_BNCAgeEffect_NKI.pdf", BNC_schaefer200x7, dpi=300,base_width = 6, base_height = 5)
```
