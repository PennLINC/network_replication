...
r_text_GBC.glasser <- expression(paste(italic("r"), " = -0.54, ",  , italic(p[spin]), "< 0.0001")) 
(GBC_glasser <- gam_figure_p.spin(GBC.axis_glasser, "GBC", "Glasser", r_text_GBC.glasser,x_pos= 270, y_pos=0.12))

r_text_GBC.gordon <- expression(paste(italic("r"), "= -0.58, ",  , italic(p[spin]), "< 0.0001"))
(GBC_gordon <- gam_figure_p.spin(GBC.axis_gordon, "GBC", "Gordon", r_text_GBC.gordon, x_pos= 270, y_pos=0.12))

r_text_GBC.schaefer200 <- expression(paste(italic("r"), "= -0.54, ",  , italic(p[spin]), "< 0.001"))
...
r_text_BNC.gordon <- expression(paste(italic("r"), "= -0.60, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.54, ",  , italic(p[spin]), "< 0.001"))
...
r_text_BNC.schaefer400x7 <- expression(paste(italic("r"), "= -0.46, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.schaefer400x17 <- expression(paste(italic("r"), "= -0.51, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_WNC.gordon <- expression(paste(italic("r"), "= -0.29, ",  , italic(p[spin]), "= N.S"))
...
r_text_WNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.19, ",  , italic(p[spin]), "= N.S."))
...
r_text_WNC.schaefer400x17 <- expression(paste(italic("r"), "= -0.20, ",  , italic(p[spin]), "= N.S."))
...
GBC_schaefer200
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Figures/OHBM_2023/GBC_schaefer200_NKI.svg", dpi=300, width = 5, height = 4)
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3/Fig3_GBCAgeEffect_NKI.pdf", dpi=300, width = 5, height = 4)
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig4_New/Fig4_GBCAgeEffect_NKI.pdf", dpi=300, width = 5, height = 5)

```



#### **Figure 6B**: BNC DevEffect  
...
save_plot("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig5_New/Fig5_BNCAgeEffect_NKI.pdf", BNC_schaefer200x7, dpi=300,base_width = 6, base_height = 5)
```



#### **Figure 6F**: WNC DevEffect  
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig5_New/Fig5_WNCAgeEffect_NKI.pdf", dpi=300, width = 6, height = 5)
...
GBC_schaefer200
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Figures/OHBM_2023/GBC_schaefer200_NKI.svg", dpi=300, width = 5, height = 4)
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/NKI_GBCAgeEffect_Covbat.pdf", dpi=300, width = 5, height = 4)
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig4_GBCAgeEffect_NKI_Covbat.pdf", dpi=300, width = 5, height = 5)
```


#### plot: Correlation between Age Effect of BNC vs. WNC
...
######(for bart)
```{r}
devTraj.centered.schaefer200x7.WNC_df1 <- devTraj.centered.schaefer200x7.WNC_df
devTraj.centered.schaefer200x7.WNC_df <- devTraj.centered.schaefer200x7.WNC_df1[c(which(devTraj.centered.schaefer200x7.WNC_df1$SA.axis_rank == 119)),] # Networks_LH_Cont_Par_2
make_smooths_fig_centered('schaefer200x7', 'WNC')
schaefer200x7_SAaxis$region[c(which(schaefer200x7_SAaxis$SA.axis_rank==119))]
 
 
 devTraj.centered.schaefer200x7.WNC_df <- devTraj.centered.schaefer200x7.WNC_df1[c(which(devTraj.centered.schaefer200x7.WNC_df1$SA.axis_rank == 111)),] # Networks_LH_Cont_Par_2
make_smooths_fig_centered('schaefer200x7', 'WNC')
 schaefer200x7_SAaxis$region[c(which(schaefer200x7_SAaxis$SA.axis_rank==111))] # Networks_LH_SalVentAttn_ParOper_2
 
 
devTraj.centered.schaefer200x7.WNC_df <- devTraj.centered.schaefer200x7.WNC_df1[c(which(devTraj.centered.schaefer200x7.WNC_df1$SA.axis_rank > 160 & devTraj.centered.schaefer200x7.WNC_df1$SA.axis_rank < 180)),] # Networks_LH_Cont_Par_2
make_smooths_fig_centered('schaefer200x7', 'WNC')
schaefer200x7_SAaxis$region[c(which(schaefer200x7_SAaxis$SA.axis_rank==193))] # Networks_LH_Default_PFC_9, Networks_RH_Default_PFCdPFCm_2
 
 
```

#### **Figure 3B**: GBC Dev Trajectory  
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTraj_NKI.pdf", dpi=1200, width = 5, height = 5)
...
#save.image(file='NKI_devEffectFigures_environment.RData')
```
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTrajRep_SM_NKI.pdf", dpi=1200, width = 5, height = 5)

schaefer200x7_attention$GBC
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTrajRep_Attention_NKI.pdf", dpi=1200, width = 5, height = 5)

schaefer200x7_default$GBC
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTrajRep_Default_NKI.pdf", dpi=1200, width = 5, height = 5)
...
for(row in c(1:nrow(schaefer200.parcel.labels))){ #for each schaefer region
  ...
  GAM.SMOOTH <- gam.smooth.predict(measure = "GBC", atlas = "schaefer200", dataset = "NKI", 
...
write.csv(gam.smooths.schaefer,"/cbica/projects/network_replication/output/NKI/GBC/GBC_age_predictedfits_schaefer200.csv", row.names = F, quote = F) 
...
plot_fittedGBC_corr("schaefer200", "GBC", "NKI")
```
...
#saveRDS(fits.SAaxis.posteriorcorrs_BNC, "/cbica/projects/network_replication/output/NKI/BNC/GAM/fits.SAaxis.posteriorcorrs_BNC.RData")

#fits.SAaxis.posteriorcorrs_WNC <- lapply(atlases, load_posterior_deriv, "WNC")
#names(fits.SAaxis.posteriorcorrs_WNC) <- atlases 
#saveRDS(fits.SAaxis.posteriorcorrs_WNC, "/cbica/projects/network_replication/output/NKI/WNC/GAM/fits.SAaxis.posteriorcorrs_WNC.RData")
...
#fits.SAaxis.posteriorcorrs_BNC <- readRDS("/cbica/projects/network_replication/output/NKI/BNC/GAM/fits.SAaxis.posteriorcorrs_BNC.RData")  

#fits.SAaxis.posteriorcorrs_WNC <- readRDS("/cbica/projects/network_replication/output/NKI/WNC/GAM/fits.SAaxis.posteriorcorrs_WNC.RData" ) 
...
saveRDS(cor.credible.intervals_GBC, "/cbica/projects/network_replication/output/NKI/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
...
#saveRDS(cor.credible.intervals_BNC, "/cbica/projects/network_replication/output/NKI/BNC/GAM/cor.credible.intervals_BNC_fitted.RData")

 

#cor.credible.intervals_WNC <- lapply(atlases, function_cor.credible.intervals, "WNC")
#names(cor.credible.intervals_WNC) <- atlases
#saveRDS(cor.credible.intervals_WNC, "/cbica/projects/network_replication/output/NKI/WNC/GAM/cor.credible.intervals_WNC_fitted.RData")

```

 
```{r load_cor.credible.intervals, include=FALSE}
cor.credible.intervals_GBC <- readRDS("/cbica/projects/network_replication/output/NKI/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
 
#cor.credible.intervals_BNC <- readRDS("/cbica/projects/network_replication/output/NKI/BNC/GAM/cor.credible.intervals_BNC.fitted.RData")

#cor.credible.intervals_WNC <- readRDS("/cbica/projects/network_replication/output/NKI/WNC/GAM/cor.credible.intervals_WNC.fitted.RData")
...
#### **Figure 5B**: Fitted GBC correlation analysis 
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig7/Fig7_NKI_GBC_ageFittedValues.pdf", dpi=300, width = 6, height = 5)
```
...
#saveRDS(deriv.SAaxis.posteriorcorrs_GBC, "/cbica/projects/network_replication/output/NKI/GBC/GAM/deriv.SAaxis.posteriorcorrs_GBC.RData")

deriv.SAaxis.posteriorcorrs_BNC <- lapply(atlases, load_posterior_deriv, "BNC")
names(deriv.SAaxis.posteriorcorrs_BNC) <- atlases 
#saveRDS(deriv.SAaxis.posteriorcorrs_BNC, "/cbica/projects/network_replication/output/NKI/BNC/GAM/deriv.SAaxis.posteriorcorrs_BNC.RData")

deriv.SAaxis.posteriorcorrs_WNC <- lapply(atlases, load_posterior_deriv, "WNC")
names(deriv.SAaxis.posteriorcorrs_WNC) <- atlases 
#saveRDS(deriv.SAaxis.posteriorcorrs_WNC, "/cbica/projects/network_replication/output/NKI/WNC/GAM/deriv.SAaxis.posteriorcorrs_WNC.RData")
...
deriv.SAaxis.posteriorcorrs_GBC <- readRDS("/cbica/projects/network_replication/output/NKI/GBC/GAM/deriv.SAaxis.posteriorcorrs_GBC.RData") 

deriv.SAaxis.posteriorcorrs_BNC <- readRDS("/cbica/projects/network_replication/output/NKI/BNC/GAM/deriv.SAaxis.posteriorcorrs_BNC.RData")  

deriv.SAaxis.posteriorcorrs_WNC <- readRDS("/cbica/projects/network_replication/output/NKI/WNC/GAM/deriv.SAaxis.posteriorcorrs_WNC.RData" ) 
...
#saveRDS(age.max.stats_GBC, "/cbica/projects/network_replication/output/NKI/GBC/GAM/age.max.stats_GBC.RData")

age.max.stats_BNC <- lapply(atlases, function_age.max.corr, "BNC")
names(age.max.stats_BNC) <- atlases 
#saveRDS(age.max.stats_BNC, "/cbica/projects/network_replication/output/NKI/BNC/GAM/age.max.stats_BNC.RData")

age.max.stats_WNC <- lapply(atlases, function_age.max.corr, "WNC")
names(age.max.stats_WNC) <- atlases 
#saveRDS(age.max.stats_WNC, "/cbica/projects/network_replication/output/NKI/WNC/GAM/age.max.stats_WNC.RData")
...
age.max.stats_GBC <- readRDS("/cbica/projects/network_replication/output/NKI/GBC/GAM/age.max.stats_GBC.RData")
age.max.stats_BNC <- readRDS("/cbica/projects/network_replication/output/NKI/BNC/GAM/age.max.stats_BNC.RData")
age.max.stats_WNC <- readRDS("/cbica/projects/network_replication/output/NKI/WNC/GAM/age.max.stats_WNC.RData")
...
names(cor.credible.intervals_GBC) <- atlases_GBC
#saveRDS(cor.credible.intervals_GBC, "/cbica/projects/network_replication/output/NKI/GBC/GAM/cor.credible.intervals_GBC.RData")
cor.credible.intervals_GBC <- readRDS("/cbica/projects/network_replication/output/NKI/GBC/GAM/cor.credible.intervals_GBC.RData")
max(abs(cor.credible.intervals_GBC$schaefer200$SA.correlation))

cor.credible.intervals_GBC$schaefer200[c(which(cor.credible.intervals_GBC$schaefer200$SA.correlation < -0.54)),]

cor.credible.intervals_BNC <- lapply(atlases, function_cor.credible.intervals, "BNC")
names(cor.credible.intervals_BNC) <- atlases
#saveRDS(cor.credible.intervals_BNC, "/cbica/projects/network_replication/output/NKI/BNC/GAM/cor.credible.intervals_BNC.RData")

 

cor.credible.intervals_WNC <- lapply(atlases, function_cor.credible.intervals, "WNC")
names(cor.credible.intervals_WNC) <- atlases
#saveRDS(cor.credible.intervals_WNC, "/cbica/projects/network_replication/output/NKI/WNC/GAM/cor.credible.intervals_WNC.RData")
...
cor.credible.intervals_BNC <- readRDS("/cbica/projects/network_replication/output/NKI/BNC/GAM/cor.credible.intervals_BNC.RData")

cor.credible.intervals_WNC <- readRDS("/cbica/projects/network_replication/output/NKI/WNC/GAM/cor.credible.intervals_WNC.RData")
```
