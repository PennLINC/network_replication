...
write.csv(BNC.subxparcel.matrix.gordon, sprintf("/cbica/projects/network_replication/output/%1$s/BNC/BNC_subxparcel_matrix_gordon.csv", dataset), row.names=F, quote=F)
write.csv(BNC.subxparcel.matrix.schaefer200x7, sprintf("/cbica/projects/network_replication/output/%1$s/BNC/BNC_subxparcel_matrix_schaefer200x7.csv", dataset), row.names=F, quote=F)
write.csv(BNC.subxparcel.matrix.schaefer400x7, sprintf("/cbica/projects/network_replication/output/%1$s/BNC/BNC_subxparcel_matrix_schaefer400x7.csv", dataset), row.names=F, quote=F)
write.csv(BNC.subxparcel.matrix.schaefer200x17, sprintf("/cbica/projects/network_replication/output/%1$s/BNC/BNC_subxparcel_matrix_schaefer200x17.csv", dataset), row.names=F, quote=F)
write.csv(BNC.subxparcel.matrix.schaefer400x17, sprintf("/cbica/projects/network_replication/output/%1$s/BNC/BNC_subxparcel_matrix_schaefer400x17.csv", dataset), row.names=F, quote=F)