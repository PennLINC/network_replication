---
title: "Compute between-Network connectivty in PNC (Schaefer200x7)"
author: "Audrey Luo"
output:
  html_document:
    code_folding: show
...
#write.csv(BNC.subxparcel.matrix.schaefer200, "/cbica/projects/network_replication/BNC/BNC_subxparcel_matrix_schaefer200x7.csv", row.names=F, quote=F)
 
  
#BNC.subxparcel.matrix.schaefer200_test <- read.csv("/cbica/projects/network_replication/BNC/BNC_subxparcel_matrix_schaefer200x7.csv") 
#GBC.subxparcel.matrix.schaefer200_test <- read.csv('/cbica/projects/network_replication/GBC/GBC_subxparcel_matrix_schaefer200x7.csv') 
