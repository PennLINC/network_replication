---
title: "BNC Developmental Trajectories: PNC (Schaefer200x17)"
...
#names(gam.smooths.schaefer200)[11] <- "SA.axis_rank"
...
r_text <- expression(paste(italic("r"), "= -0.59, ", italic(p[spin]), "< 0.0001"))
...
#ggsave(schaefer200_agepeak, file="/cbica/projects/network_replication/adapted_Rscripts/Figures/Schaefer200/BNC/schaefer200x17_agepeak.pdf", width = 6, height=4, dpi=300)
