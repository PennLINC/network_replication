---
title: "BNC GAMs: PNC (Schaefer400x17)"
...
```{r} 
BNC_subxparcel_matrix_schaefer400 <- read.csv("/cbica/projects/network_replication/BNC/BNC_subxparcel_matrix_schaefer400x17.csv") #participant x schaefer region BNC spreadsheet
...
names(BNC.schaefer400.pnc) <- gsub('X17Networks_', "", names(BNC.schaefer400.pnc))
#write.csv(BNC.schaefer400.pnc, "/cbica/projects/network_replication/BNC/BNCschaefer400x17_demographics_finalsample.csv")
...
```{r}
BNC.schaefer400.pnc <- read.csv('/cbica/projects/network_replication/BNC/BNCschaefer400x17_demographics_finalsample.csv')
```
...
#write.csv(gam.BNC.age.schaefer400, "/cbica/projects/network_replication/BNC/GAM/GAMresults.BNC.age.schaefer400x17.csv", row.names = F, quote = F)
```
 
# load GAMs output
```{r} 
gam.BNC.age.schaefer400 <- read.csv("/cbica/projects/network_replication/BNC/GAM/GAMresults.BNC.age.schaefer400x17.csv")
```
...
#write.csv(gam.smooths.schaefer400,"/cbica/projects/network_replication/BNC/GAM/GAMsmoothfits.BNC.age.schaefer400x17.csv", row.names = F, quote = F)
#write.csv(gam.peaks.schaefer400, "/cbica/projects/network_replication/BNC/GAM/GAMpeaks.BNC.age.schaefer400x17.csv", row.names = F, quote = F)
