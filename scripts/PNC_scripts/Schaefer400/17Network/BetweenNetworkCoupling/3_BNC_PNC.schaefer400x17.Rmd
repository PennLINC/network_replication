---
title: "BNC Developmental Trajectories: PNC (Schaefer400x17)"
...
gam.BNC.age.schaefer400 <- read.csv("/Users/audluo/cbica/projects/network_replication/BNC/GAM/GAMresults.BNC.age.schaefer400x17.csv")

gam.BNC.age.schaefer400 <- gam.BNC.age.schaefer400 %>% select(-label)
gam.BNC.age.schaefer400$label <- schaefer400_SAaxis$label
 

gam.smooths.schaefer400 <- read.csv("/Users/audluo/cbica/projects/network_replication/BNC/GAM/GAMsmoothfits.BNC.age.schaefer400x17.csv")
gam.smooths.schaefer400$orig_parcelname <- gam.smooths.schaefer400$label
 

gam.agepeaks.schaefer400 <- read.csv("/Users/audluo/cbica/projects/network_replication/BNC/GAM/GAMpeaks.BNC.age.schaefer400x17.csv")
...
#ggsave(schaefer400_predBNC, file="/cbica/projects/network_replication/adapted_Rscripts/Figures/Schaefer400/BNC/schaefer400x17_predBNC.pdf", width = 4, height=4, dpi=300)
...
#ggsave(schaefer400_agepeakR, file="/cbica/projects/network_replication/adapted_Rscripts/Figures/Schaefer400/BNC/schaefer400x17_agepeakR.pdf", width = 6, height=4, dpi=300)
...
(schaefer400_agepeakL <- ggplot() + geom_brain(data=left_gam.agepeaks.schaefer400, 
                      ...
                      hemi = "left") + 
  scale_fill_gradientn(colors = viridis_pal(option="B")(10)) + theme_void())
#ggsave(schaefer400_agepeakL, file="/cbica/projects/network_replication/adapted_Rscripts/Figures/Schaefer400/BNC/schaefer400x17_agepeakL.pdf", width = 6, height=4, dpi=300)
