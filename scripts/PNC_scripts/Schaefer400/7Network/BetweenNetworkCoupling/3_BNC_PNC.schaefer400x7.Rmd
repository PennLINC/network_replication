---
title: "BNC Developmental Trajectories: PNC (Schaefer400x7)"
...
index_schaefer400x7to7 <- read.csv("/cbica/projects/network_replication/software/schaefer7to7_reordering/index_schaefer400x7to7.csv", header=F)
 
index_schaefer400x7to7$V1 <- as.numeric(index_schaefer400x7to7$V1)
schaefer400_SAaxis <-schaefer400_SAaxis[index_schaefer400x7to7$V1,]
...
df.dev.spin <- rbind(existingDF[1:400,], existingDF[201:400,]) #format df as left hemisphere -> right hemisphere for spin tests
