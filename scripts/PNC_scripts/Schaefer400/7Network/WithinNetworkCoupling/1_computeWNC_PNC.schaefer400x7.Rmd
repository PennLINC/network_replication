---
title: "Compute Within-Network connectivty in PNC (Schaefer400x7)"
author: "Audrey Luo"
output:
  html_document:
    code_folding: show
...
names(as.data.frame(WNC.subxparcel.matrix.schaefer400)[-1]
#write.csv(WNC.subxparcel.matrix.schaefer400, "/cbica/projects/network_replication/WNC/WNC_subxparcel_matrix_schaefer400x7.csv", row.names=F, quote=F)
  
WNC.subxparcel.matrix.schaefer400_test <- read.csv("/cbica/projects/network_replication/WNC/WNC_subxparcel_matrix_schaefer400x7.csv") 
