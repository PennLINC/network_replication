---
title: "WNC Developmental Trajectories: PNC (Schaefer400x7)"
...
gam.smooths.schaefer400 <- read.csv("/cbica/projects/network_replication/WNC/GAM/GAMsmoothfits.WNC.age.schaefer400x7.csv")
gam.smooths.schaefer400$orig_parcelname <- gam.smooths.schaefer400$label
 

gam.agepeaks.schaefer400 <- read.csv("/cbica/projects/network_replication/WNC/GAM/GAMpeaks.WNC.age.schaefer400x7.csv")
...
#schaefer400.coords <- read.csv("/cbica/projects/network_replication/software/rotate_parcellation/Schaefer2018_400Parcels_7Networks_order_FSLMNI152_1mm.Centroid_RAS_reordered.csv") #coordinates of schaefer400.coords parcel centroids on the freesurfer sphere
...
cor.test(WNC.axis$GAM.age.AdjRsq, as.numeric(WNC.axis$SA.axis_rank), method=c("spearman"), exact=F)
r_text <- expression(paste(italic("r"), "= -0.32, ", italic(p[spin]), "< 0.05"))
...
annotate(geom="text", x=300, y=0.055, label=r_text, color="black"))
# ggsave(schaefer400_SA.AgeEffect, file="/cbica/projects/network_replication/adapted_Rscripts/Figures/Schaefer400/WNC/schaefer400x7_SA.AgeEffect.pdf", width = 5, height=4, dpi=300)
...
(schaefer400_SA.AgeEffect <- ggplot(WNC.axis_rmOutlier, aes(x=SA.axis_rank, y=GAM.age.AdjRsq, fill = SA.axis_rank_signif)) + geom_point(color = "white", shape = 21, size=2) +
...
#ggsave(schaefer400_predWNC, file="/cbica/projects/network_replication/adapted_Rscripts/Figures/Schaefer400/WNC/schaefer400x7_predWNC.pdf", width = 4, height=4, dpi=300)
...
#ggsave(schaefer400_agepeak, file="/cbica/projects/network_replication/adapted_Rscripts/Figures/Schaefer400/WNC/schaefer400x7_agepeak.pdf", width = 6, height=4, dpi=300)
