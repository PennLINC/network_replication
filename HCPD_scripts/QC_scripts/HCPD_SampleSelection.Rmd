...
write.csv(collated_HCPD.xcp_headMotion, "/cbica/projects/network_replication/input/HCPD/sample_selection/collated_HCPD.xcp_headMotion_20221224.csv", row.names=F)
```
...
write.csv(final_dem_df, "/cbica/projects/network_replication/input/HCPD/sample_selection/HCPD_demographics_finalsample_20221226.csv", row.names=F)
...
saveRDS(HCPD_qc_filenames_atlases_restOnly, "/cbica/projects/network_replication/input/HCPD/sample_selection/fMRIinclude_CUBIDS_restOnly_20221227.RData")
...
HCPD_qc_filenames_atlases_restOnly <- readRDS("/cbica/projects/network_replication/input/HCPD/sample_selection/fMRIinclude_CUBIDS_restOnly_20221227.RData")
...
write.csv(final_dem_restOnly_df, "/cbica/projects/network_replication/input/HCPD/sample_selection/HCPD_demographics_finalsample_restOnly_20230103.csv", row.names=F)
``` 
