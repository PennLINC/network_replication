...
write.csv(spearman_rho, "/cbica/projects/network_replication/output/HCPD/spearman_rho.csv")
...
saveRDS(list(p_spin_GBC, p_spin_BNC, p_spin_WNC), "/cbica/projects/network_replication/output/HCPD/pspin_vals.RData")
```
...
spearman_rho <- read.csv("/cbica/projects/network_replication/output/HCPD/spearman_rho.csv")
pspin_vals <- readRDS("/cbica/projects/network_replication/output/HCPD/pspin_vals.RData")
...
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HCPD_GBCAgeEffect_noCovbat.pdf", dpi=300, width = 5, height = 4)
```
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HCPD_GBCDevTraj_noCovbat.pdf", dpi=300, width = 5, height = 4)
