...
library(purrr)
library(pammtools)
#load('HCPD_devEffectFigures_environment.RData')
...
#saveRDS(list(p_spin_GBC), "/cbica/projects/network_replication/output/HCPD/sensitivity_analyses/pspin_vals.RData")

#saveRDS(list(p_spin_GBC, p_spin_BNC, p_spin_WNC), "/cbica/projects/network_replication/output/HCPD/sensitivity_analyses/pspin_vals.RData")
```
...
r_text_GBC.schaefer200 <- expression(paste(italic("r"), "= -0.70, ",  , italic(p[spin]), "< 0.0001"))
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Supplementary/FigS3_GBCAgeEffect_HCPD.pdf", dpi=300, width = 5, height = 5)
...
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HCPD_BNCAgeEffect_noCovbat.pdf", dpi=300, width = 5, height = 4)
...
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HCPD_WNCAgeEffect_noCovbat.pdf", dpi=300, width = 5, height = 4)
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Supplementary/FigS3_GBCDevTraj_HCPD.pdf", dpi=300, width = 5, height = 5)
