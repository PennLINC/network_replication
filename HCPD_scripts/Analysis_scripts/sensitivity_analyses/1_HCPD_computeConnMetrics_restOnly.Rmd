...
write.csv(GBC.subxparcel.matrix.schaefer200, "/cbica/projects/network_replication/output/HCPD/sensitivity_analyses/GBC/GBC_subxparcel_matrix_schaefer200.csv", row.names=F, quote=F)
...
# Harmonize GBC
data.harmonized_GBC <- covfam(data=GBC_subxparcel_schaefer200, bat = as.factor(participants$site), covar = covar_df, gam, y ~ s(age, k=3, fx=T) + as.factor(sex) + as.numeric(meanFD_avgSes))
```
