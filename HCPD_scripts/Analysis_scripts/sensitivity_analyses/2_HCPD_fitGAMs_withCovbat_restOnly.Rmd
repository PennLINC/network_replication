...
# GBC
## creates GBC.glasser.HCPD, GBC.gordon.HCPD, GBC.schaefer200.HCPD, GBC.schaefer400.HCPD csv's
...
GBC.glasser.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/GBC/GBCglasser_demographics_finalsample_covbat.csv", dataset))
GBC.gordon.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/GBC/GBCgordon_demographics_finalsample_covbat.csv", dataset)) 
...
GBC.schaefer400.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/GBC/GBCschaefer400_demographics_finalsample_covbat.csv", dataset)) 
names(GBC.schaefer400.HCPD) <- gsub('X17Networks', "Networks", names(GBC.schaefer400.HCPD)) 
 
 
# BNC
BNC.gordon.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/BNC/BNCgordon_demographics_finalsample_covbat.csv", dataset))   
BNC.schaefer200x7.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/BNC/BNCschaefer200x7_demographics_finalsample_covbat.csv", dataset)) 
names(BNC.schaefer200x7.HCPD) <- gsub("X7", "", names(BNC.schaefer200x7.HCPD))

BNC.schaefer200x17.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/BNC/BNCschaefer200x17_demographics_finalsample_covbat.csv", dataset))    
names(BNC.schaefer200x17.HCPD) <- gsub("X17", "", names(BNC.schaefer200x17.HCPD))

BNC.schaefer400x7.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/BNC/BNCschaefer400x7_demographics_finalsample_covbat.csv", dataset))
names(BNC.schaefer400x7.HCPD) <- gsub("X7", "", names(BNC.schaefer400x7.HCPD))

BNC.schaefer400x17.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/BNC/BNCschaefer400x17_demographics_finalsample_covbat.csv", dataset))   
names(BNC.schaefer400x17.HCPD) <- gsub("X17", "", names(BNC.schaefer400x17.HCPD))

# WNC
WNC.gordon.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/WNC/WNCgordon_demographics_finalsample_covbat.csv", dataset))    
WNC.schaefer200x7.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/WNC/WNCschaefer200x7_demographics_finalsample_covbat.csv", dataset))
names(WNC.schaefer200x7.HCPD) <- gsub("X7", "", names(WNC.schaefer200x7.HCPD))

WNC.schaefer200x17.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/WNC/WNCschaefer200x17_demographics_finalsample_covbat.csv", dataset)) 
names(WNC.schaefer200x17.HCPD) <- gsub("X17", "", names(WNC.schaefer200x17.HCPD))

WNC.schaefer400x7.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/WNC/WNCschaefer400x7_demographics_finalsample_covbat.csv", dataset)) 
names(WNC.schaefer400x7.HCPD) <- gsub("X7", "", names(WNC.schaefer400x7.HCPD))

WNC.schaefer400x17.HCPD <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/WNC/WNCschaefer400x17_demographics_finalsample_covbat.csv", dataset))  
