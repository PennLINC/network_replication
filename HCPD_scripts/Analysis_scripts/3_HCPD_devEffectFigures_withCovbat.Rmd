...
Makes Figures 2C, 2G, 2K, 2O, 4C, 5C, 5G
...
#### Plot Figure 2C: GBC Dev Trajectory  
...
saveRDS(list(p_spin_BNC, p_spin_WNC), "/cbica/projects/network_replication/output/HCPD/pspin_vals_covbat.RData")
```
