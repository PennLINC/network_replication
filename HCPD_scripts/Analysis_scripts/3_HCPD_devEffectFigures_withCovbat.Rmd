...
Makes Figures 3C, 3G, 3K, 3O, 4C, 5C, 6C, 6G
...
#### Plot Figure 3C: GBC Dev Trajectory  
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTraj_HCPD.pdf", dpi=1200, width = 5, height = 5)
```
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_SM_HCPD.pdf", dpi=1200, width = 5, height = 5)

schaefer200x7_attention 
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_Attention_HCPD.pdf", dpi=1200, width = 5, height = 5)

schaefer200x7_default 
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_Default_HCPD.pdf", dpi=1200, width = 5, height = 5)
...
#GBC
r_text_GBC.glasser <- expression(paste(italic("r"), " = -0.50, ",  , italic(p[spin]), "< 0.001")) 
...
r_text_GBC.gordon <- expression(paste(italic("r"), "= -0.53, ",  , italic(p[spin]), "< 0.0001"))
...
(GBC_schaefer200 <- gam_figure_p.spin(GBC.axis_schaefer200, "GBC", "Schaefer200", r_text_GBC.schaefer200, 
                                  x_pos= 150, y_pos=0.12, ylim_lower=-0.09, ylim_upper=0.18))

r_text_GBC.schaefer400 <- expression(paste(italic("r"), "= -0.63, ",  , italic(p[spin]), "< 0.0001"))
...
#BNC
r_text_BNC.gordon <- expression(paste(italic("r"), "= -0.52, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.55, ",  , italic(p[spin]), "< 0.001"))
...
r_text_BNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.63, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.schaefer400x7 <- expression(paste(italic("r"), "= -0.56, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.schaefer400x17 <- expression(paste(italic("r"), "= -0.64, ",  , italic(p[spin]), "< 0.0001"))
(BNC_schaefer400x17 <- gam_figure_p.spin(BNC.axis_schaefer400x17, "BNC", "schaefer400x17", r_text_BNC.schaefer400x17, 
                                  x_pos= 260, y_pos=0.1, ylim_lower=-0.07, ylim_upper=0.10))
 

#WNC
r_text_WNC.gordon <- expression(paste(italic("r"), "= -0.13, ",  , italic(p[spin]), "= N.S"))
...
r_text_WNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.31, ",  , italic(p[spin]), "< 0.001"))
...
r_text_WNC.schaefer400x7 <- expression(paste(italic("r"), "= -0.33, ",  , italic(p[spin]), "= N.S."))
...
r_text_WNC.schaefer400x17 <- expression(paste(italic("r"), "= -0.16, ",  , italic(p[spin]), "= N.S."))
...
GBC_schaefer200
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig4/Fig4_GBCAgeEffect_HCPD_Covbat.pdf", dpi=300, width = 5, height = 5)
```
...
saveRDS(cor.credible.intervals, "/cbica/projects/network_replication/output/HCPD/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
  
```

 
```{r load_cor.credible.intervals, include=FALSE}
cor.credible.intervals <- readRDS("/cbica/projects/network_replication/output/HCPD/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
```
...
SA_metric_corr_GBC 
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig5/Fig5_HCPD_GBC_ageFittedValues.pdf", dpi=1200, width = 5, height = 5)
```


#### **Figure 6C** 
#### Plot Figure 6C: BNC DevEffect  
```{r Fig2, fig.height= 8, fig.width= 16, warning=FALSE, cache=TRUE}
BNC_schaefer200x7
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig6/Fig6_BNCAgeEffect_HCPD_covbat.pdf", dpi=300, width = 6, height = 5)
```

#### **Figure 6G**
#### Plot Figure 6G: BNC DevEffect  
```{r Fig3, fig.height= 8, fig.width= 16, warning=FALSE, cache=TRUE}
WNC_schaefer200x7
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig6/Fig6_WNCAgeEffect_HCPD_covbat.pdf", dpi=300, width = 6, height = 5)
```
