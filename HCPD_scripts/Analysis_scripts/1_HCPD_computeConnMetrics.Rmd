...
# GBC, BNC, WNC, and edge-level connectivity were computed on cubic as jobs. The following code chunks consolidate all the steps that were executed. I've consolidated them here for documentation and easy reference.
For computeGBC, /cbica/projects/network_replication/Rscripts/HCPD_scripts/Analysis_scripts/connMetrics_scripts/computeGBC_HCPD.sh was submitted as a job. This shell script uses the following Rscript to execute R code: /cbica/projects/network_replication/Rscripts/functions/main_analyses/computeGBC.R. Note that computeGBC.R uses functions from /cbica/projects/network_replication/Rscripts/functions/main_analyses/computeConnectivityMetrics.R.

A similar process was used for BNC, WNC, and edge-level connectivity.
- Shell script: /cbica/projects/network_replication/Rscripts/HCPD_scripts/Analysis_scripts/connMetrics_scripts/compute<metric>_HCPD.sh
- Rscript: /cbica/projects/network_replication/Rscripts/functions/main_analyses/compute<metric>.R
- Functions: /cbica/projects/network_replication/Rscripts/functions/main_analyses/computeConnectivityMetrics.R 
```{r computeGBC}
# make output dfs: 
...
This chunk was submitted as a job on cubic due to high computational requirements. 
Shell script that submits Rscript: /cbica/projects/network_replication/Rscripts/HCPD_scripts/Analysis_scripts/connMetrics_scripts/covbat_edges_HCPD.sh
Rscript: /cbica/projects/network_replication/Rscripts/functions/main_analyses/covbat_edges.R
```{r edge_covbat}
