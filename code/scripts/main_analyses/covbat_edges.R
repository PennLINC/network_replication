...
apply_covbat_edge <- function(atlas, dataset) {
  subxedge <- readRDS(sprintf("/cbica/projects/network_replication/manuscript/output/%1$s/edge/subxedge_%2$s.RData", dataset, atlas))
  ...
  saveRDS(data.harmonized_covbat, sprintf("/cbica/projects/network_replication/manuscript/output/%1$s/edge/subxedge_%2$s.RData", dataset, atlas))
