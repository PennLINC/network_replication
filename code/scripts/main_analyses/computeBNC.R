...
metric_output_dir <- paste0(outputs_root, "BNC/")
...
################## 
# make output dfs: 
## BNC.subxparcel.matrix.schaefer200x7
...
#write.csv(BNC.subxparcel.matrix.gordon, sprintf("%1$sBNC_subxparcel_matrix_gordon.csv", metric_output_dir), row.names=F, quote=F)
write.csv(BNC.subxparcel.matrix.schaefer200x7, sprintf("%1$sBNC_subxparcel_matrix_schaefer200x7.csv", metric_output_dir), row.names=F, quote=F)
#write.csv(BNC.subxparcel.matrix.schaefer400x7, sprintf("%1$sBNC_subxparcel_matrix_schaefer400x7.csv", metric_output_dir), row.names=F, quote=F)
#write.csv(BNC.subxparcel.matrix.schaefer200x17, sprintf("%1$sBNC_subxparcel_matrix_schaefer200x17.csv", metric_output_dir), row.names=F, quote=F)
#write.csv(BNC.subxparcel.matrix.schaefer400x17, sprintf("%1$sBNC_subxparcel_matrix_schaefer400x17.csv", metric_output_dir), row.names=F, quote=F)