...
HCPD_CIFTI_summary  <- readRDS("/cbica/projects/network_replication/input/HCPD/sample_selection/HCPD_FinalSample_filenames.RData") 
...
listCifti <- function(subject, list_filepath, ciftiFiles_df){
  ...
  saveRDS(cifti_list, paste0(cifti_lists_dir, subject, "_timeseriesTaskandRest.RData"))
