---
title: "HBN Figures - Sensitivity Analysis"
author: "Audrey Luo"
date: "2022-08-04"
...
library(purrr)
library(pammtools)
#load('HBN_devEffectFigures_environment.RData')
...
for(i in c(1:length(atlases_GBC))){
  ...
  assign(df_name, read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/%2$s/GAM/GAMresults.%2$s.age.%3$s_covbat.csv", dataset, metric, atlases_GBC[i])))
...
for(i in c(1:length(atlases))){
  ...
  assign(df_name, read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/%2$s/GAM/GAMresults.%2$s.age.%3$s_covbat.csv", dataset, metric, atlases[i])))
  assign(df_name, get(df_name) %>% select(-label))
...
for(i in c(1:length(atlases_GBC))){
  ...
  assign(filename, read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/%2$s/GAM/%3$s_covbat.csv", dataset, metric, filename)))
  print(filename)
} 
...
for(i in c(1:length(atlases_GBC))){
  ...
  write.csv(get(filename), sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/%2$s/GAM/%3$s_covbat.csv", dataset, metric, filename))
  print(df_name)
} 
...
#write.csv(spearman_rho, "/cbica/projects/network_replication/output/HBN/sensitivity_analyses/spearman_rho.csv")
...
#saveRDS(list(p_spin_GBC), "/cbica/projects/network_replication/output/HBN/sensitivity_analyses/pspin_vals.RData")

#saveRDS(list(p_spin_GBC, p_spin_BNC, p_spin_WNC), "/cbica/projects/network_replication/output/HBN/sensitivity_analyses/pspin_vals.RData")
```
...
spearman_rho <- read.csv("/cbica/projects/network_replication/output/HBN/sensitivity_analyses/spearman_rho.csv")
pspin_vals <- readRDS("/cbica/projects/network_replication/output/HBN/sensitivity_analyses/pspin_vals.RData")
...
r_text_GBC.schaefer400 <- expression(paste(italic("r"), "= -0.68, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.68, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.68, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.schaefer400x7 <- expression(paste(italic("r"), "= -0.62, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_WNC.gordon <- expression(paste(italic("r"), "= -0.11, ",  , italic(p[spin]), "= N.S"))
(WNC_gordon <- gam_figure_p.spin(WNC.axis_gordon, "WNC", "Gordon", r_text_WNC.gordon, x_pos= 270, y_pos=0.12))

r_text_WNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.17, ",  , italic(p[spin]), "= N.S."))
...
r_text_WNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.17, ",  , italic(p[spin]), "= N.S."))
...
r_text_WNC.schaefer400x7 <- expression(paste(italic("r"), "= -0.26, ",  , italic(p[spin]), "= N.S."))
...
r_text_WNC.schaefer400x17 <- expression(paste(italic("r"), "= -0.11, ",  , italic(p[spin]), "= N.S."))
...
GBC_schaefer200
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Figures/OHBM_2023/GBC_schaefer200_HBN.svg", dpi=300, width = 5, height = 4)

ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Supplementary/FigS3_GBCAgeEffect_HBN.pdf", dpi=300, width = 5, height = 5)
...
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HBN_BNCAgeEffect_noCovbat.pdf", dpi=300, width = 5, height = 4)
...
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HBN_WNCAgeEffect_noCovbat.pdf", dpi=300, width = 5, height = 4)
...
for(i in c(1:length(atlases_GBC))){
  ...
  assign(df_name, make_gam.smooths_centered_covbat(metric, atlases_GBC[i], dataset)) #commenting out to prevent make_gam.smooths_centered_covbat from making new csv's each time you run code
  print(df_name)
} 
...
for(i in c(1:length(atlases))){
  ...
  assign(df_name, make_gam.smooths_centered_covbat(metric, atlases[i], dataset)) #commenting out to prevent make_gam.smooths_centered_covbat from making new csv's each run
  print(df_name)
} 
...
for(i in c(1:length(atlases_GBC))){
  df_name <- paste0("devTraj.centered.", atlases_GBC[i], ".", metric, "_df")
  assign(df_name, read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/sensitivity_analyses/%2$s/GAM/GAMsmoothfits.%2$s.age.%3$s_centered_covbat.csv", dataset, metric, atlases_GBC[i])))
  print(df_name)
}
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Supplementary/FigS3_GBCDevTraj_HBN.pdf", dpi=300, width = 5, height = 5)
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HBN_BNCDevTraj_noCovbat.pdf", dpi=300, width = 5, height = 4)
```
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HBN_WNCDevTraj_noCovbat.pdf", dpi=300, width = 5, height = 4)
```
...
make_SM.middle.assoc_dataframe <- function(atlas_name, metric){
  ...
  # then run the make_gam.smooths_centered_covbat function to make the trajectories 
...
#save.image(file='HBN_devEffectFigures_environment.RData')
```
...
schaefer200x7_GBC_SomMot <- make_repParcel.fig("GBC", "schaefer200x7", "SomMot", "#24A6A8FF", SA_rank=40, "schaefer7_200", c(0.04, 0.029, 0.01, 0.07)) 
...
main.plot_attention <- ggplot(smooth_fits_attention,aes(age,est,group=SA.axis_rank)) + 
      ...
      theme_classic()
attention_schaefer200.fig_inset <- ggplot() + geom_brain(data=schaefer200x7_SAaxis_fig.df, 
                      atlas=schaefer7_200, 
...
#saveRDS(deriv.SAaxis.posteriorcorrs_GBC, "/cbica/projects/network_replication/output/HBN/GBC/GAM/deriv.SAaxis.posteriorcorrs_GBC.RData")

deriv.SAaxis.posteriorcorrs_BNC <- lapply(atlases, load_posterior_deriv, "BNC")
names(deriv.SAaxis.posteriorcorrs_BNC) <- atlases 
#saveRDS(deriv.SAaxis.posteriorcorrs_BNC, "/cbica/projects/network_replication/output/HBN/BNC/GAM/deriv.SAaxis.posteriorcorrs_BNC.RData")

deriv.SAaxis.posteriorcorrs_WNC <- lapply(atlases, load_posterior_deriv, "WNC")
names(deriv.SAaxis.posteriorcorrs_WNC) <- atlases 
#saveRDS(deriv.SAaxis.posteriorcorrs_WNC, "/cbica/projects/network_replication/output/HBN/WNC/GAM/deriv.SAaxis.posteriorcorrs_WNC.RData")
...
deriv.SAaxis.posteriorcorrs_GBC <- readRDS("/cbica/projects/network_replication/output/HBN/GBC/GAM/deriv.SAaxis.posteriorcorrs_GBC.RData") 

deriv.SAaxis.posteriorcorrs_BNC <- readRDS("/cbica/projects/network_replication/output/HBN/BNC/GAM/deriv.SAaxis.posteriorcorrs_BNC.RData")  

deriv.SAaxis.posteriorcorrs_WNC <- readRDS("/cbica/projects/network_replication/output/HBN/WNC/GAM/deriv.SAaxis.posteriorcorrs_WNC.RData" ) 
...
#saveRDS(age.max.stats_GBC, "/cbica/projects/network_replication/output/HBN/GBC/GAM/age.max.stats_GBC.RData")

age.max.stats_BNC <- lapply(atlases, function_age.max.corr, "BNC")
names(age.max.stats_BNC) <- atlases 
#saveRDS(age.max.stats_BNC, "/cbica/projects/network_replication/output/HBN/BNC/GAM/age.max.stats_BNC.RData")

age.max.stats_WNC <- lapply(atlases, function_age.max.corr, "WNC")
names(age.max.stats_WNC) <- atlases 
#saveRDS(age.max.stats_WNC, "/cbica/projects/network_replication/output/HBN/WNC/GAM/age.max.stats_WNC.RData")
...
age.max.stats_GBC <- readRDS("/cbica/projects/network_replication/output/HBN/GBC/GAM/age.max.stats_GBC.RData")
age.max.stats_BNC <- readRDS("/cbica/projects/network_replication/output/HBN/BNC/GAM/age.max.stats_BNC.RData")
age.max.stats_WNC <- readRDS("/cbica/projects/network_replication/output/HBN/WNC/GAM/age.max.stats_WNC.RData")
```
...
#saveRDS(cor.credible.intervals_GBC, "/cbica/projects/network_replication/output/HBN/GBC/GAM/cor.credible.intervals_GBC.RData")
...
#saveRDS(cor.credible.intervals_BNC, "/cbica/projects/network_replication/output/HBN/BNC/GAM/cor.credible.intervals_BNC.RData")

 

cor.credible.intervals_WNC <- lapply(atlases, function_cor.credible.intervals, "WNC")
names(cor.credible.intervals_WNC) <- atlases
#saveRDS(cor.credible.intervals_WNC, "/cbica/projects/network_replication/output/HBN/WNC/GAM/cor.credible.intervals_WNC.RData")

```

 
```{r load_cor.credible.intervals, include=FALSE}
cor.credible.intervals_GBC <- readRDS("/cbica/projects/network_replication/output/HBN/GBC/GAM/cor.credible.intervals_GBC.RData")
 
cor.credible.intervals_BNC <- readRDS("/cbica/projects/network_replication/output/HBN/BNC/GAM/cor.credible.intervals_BNC.RData")

cor.credible.intervals_WNC <- readRDS("/cbica/projects/network_replication/output/HBN/WNC/GAM/cor.credible.intervals_WNC.RData")
```
