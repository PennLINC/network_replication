...
r_text_BNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.70, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_WNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.37, ",  , italic(p[spin]), "< 0.0001"))
(WNC_schaefer200x7 <- gam_figure_p.spin(WNC.axis_schaefer200x7, "WNC", "schaefer200x7", r_text_WNC.schaefer200x7, 
                                 x_pos= 150, y_pos=0.17, ylim_lower=-0.055, ylim_upper=0.17))
...
r_text_WNC.schaefer400x7 <- expression(paste(italic("r"), "= -0.31, ",  , italic(p[spin]), "< 0.01"))
