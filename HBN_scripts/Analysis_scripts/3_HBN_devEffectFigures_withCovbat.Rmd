...
write.csv(spearman_rho, "/cbica/projects/network_replication/output/HBN/spearman_rho_covbat.csv")
...
#saveRDS(list(p_spin_GBC, p_spin_BNC, p_spin_WNC), "/cbica/projects/network_replication/output/HBN/pspin_vals_covbat.RData")
```
...
spearman_rho <- read.csv("/cbica/projects/network_replication/output/HBN/spearman_rho_covbat.csv")
pspin_vals <- readRDS("/cbica/projects/network_replication/output/HBN/pspin_vals_covbat.RData")

 
#GBC
#list(p_spin_GBC, p_spin_BNC, p_spin_WNC)
 
r_text_GBC.glasser <- expression(paste(italic("r"), " = -0.75, ",  , italic(p[spin]), "< 0.0001")) 
(GBC_glasser <- gam_figure_p.spin(GBC.axis_glasser, "GBC", "Glasser", r_text_GBC.glasser,x_pos= 270, y_pos=0.12))

r_text_GBC.gordon <- expression(paste(italic("r"), "= -0.67, ",  , italic(p[spin]), "< 0.0001"))
...
(GBC_schaefer200 <- gam_figure_p.spin(GBC.axis_schaefer200, "GBC", "Schaefer200", r_text_GBC.schaefer200, x_pos= 150, y_pos=0.09))

r_text_GBC.schaefer400 <- expression(paste(italic("r"), "= -0.72, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.gordon <- expression(paste(italic("r"), "= -0.67, ",  , italic(p[spin]), "< 0.0001"))
...
(BNC_schaefer200x7 <- gam_figure_p.spin(BNC.axis_schaefer200x7, "BNC", "schaefer200x7", r_text_BNC.schaefer200x7, x_pos= 160, y_pos=0.08))

r_text_BNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.72, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.schaefer400x7 <- expression(paste(italic("r"), "= -0.66, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_BNC.schaefer400x17 <- expression(paste(italic("r"), "= -0.72, ",  , italic(p[spin]), "< 0.0001"))
...
r_text_WNC.gordon <- expression(paste(italic("r"), "= -0.14, ",  , italic(p[spin]), "= N.S"))
(WNC_gordon <- gam_figure_p.spin(WNC.axis_gordon, "WNC", "Gordon", r_text_WNC.gordon, x_pos= 270, y_pos=0.12))

r_text_WNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.41, ",  , italic(p[spin]), "< 0.0001"))
(WNC_schaefer200x7 <- gam_figure_p.spin(WNC.axis_schaefer200x7, "WNC", "schaefer200x7", r_text_WNC.schaefer200x7, x_pos= 150, y_pos=0.15))

r_text_WNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.32, ",  , italic(p[spin]), "< 0.01"))
...
r_text_WNC.schaefer400x7 <- expression(paste(italic("r"), "= -0.36, ",  , italic(p[spin]), "< 0.001"))
...
r_text_WNC.schaefer400x17 <- expression(paste(italic("r"), "= -0.19, ",  , italic(p[spin]), "< 0.05"))
...
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HBN_GBCAgeEffect_Covbat.pdf", dpi=300, width = 5, height = 4)
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig4_New/Fig4_GBCAgeEffect_HBN_Covbat.pdf", dpi=300, width = 5, height = 5)
```
...
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HBN_BNCAgeEffect_Covbat.pdf", dpi=300, width = 5, height = 4)


ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig5_New/Fig5_BNCAgeEffect_HBN_covbat.pdf", dpi=300, width = 6, height = 5)
...
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HBN_WNCAgeEffect_Covbat.pdf", dpi=300, width = 5, height = 4)

ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig5_New/Fig5_WNCAgeEffect_HBN_covbat.pdf", dpi=300, width = 6, height = 5)
...
r_text_GBC.schaefer200 <- expression(paste(italic("r"), "= -0.73, ",  , italic(p[spin]), "< 0.0001"))
(GBC_schaefer200 <- gam_figure_p.spin_Val(GBC.axis_schaefer200, "GBC", "Schaefer200", r_text_GBC.schaefer200, x_pos= 150, y_pos=0.09))

GBC_schaefer200
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Figures/OHBM_2023/GBC_schaefer200_HBN.svg", dpi=300, width = 5, height = 4)
#ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HBN_GBCAgeEffect_Covbat.pdf", dpi=300, width = 5, height = 4)
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig4_GBCAgeEffect_HBN_Covbat.pdf", dpi=300, width = 5, height = 5)
```
...
for(i in c(1:length(atlases))){
  ...
  assign(df_name, make_gam.smooths_centered_covbat(metric, atlases[i], dataset))  
  print(df_name)
} 
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTraj_HBN_covbat.pdf", dpi=1200, width = 5, height = 5)
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HBN_BNCDevTraj_Covbat.pdf", dpi=300, width = 5, height = 4)
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/harmonization/HBN_WNCDevTraj_Covbat.pdf", dpi=300, width = 5, height = 4)
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTrajRep_SM_HBN.pdf", dpi=1200, width = 5, height = 5)

schaefer200x7_attention$GBC
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTrajRep_Attention_HBN.pdf", dpi=1200,width = 5, height = 5)

schaefer200x7_default$GBC
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Fig3_New/Fig3_GBCDevTrajRep_Default_HBN.pdf", dpi=1200,width = 5, height = 5)
...
for(row in c(1:nrow(schaefer200.parcel.labels))){ #for each schaefer region
  ...
  GAM.SMOOTH <- gam.smooth.predict(measure = "GBC", atlas = "schaefer200", dataset = "HBN", 
...
write.csv(gam.smooths.schaefer,"/cbica/projects/network_replication/output/HBN/GBC/GBC_age_predictedfits_schaefer200.csv", row.names = F, quote = F) 
...
plot_fittedGBC_corr("schaefer200", "GBC", "HBN")
```
...
saveRDS(fits.SAaxis.posteriorcorrs_GBC, "/cbica/projects/network_replication/output/HBN/GBC/GAM/fits.SAaxis.posteriorcorrs_GBC.RData")
...
#saveRDS(fits.SAaxis.posteriorcorrs_BNC, "/cbica/projects/network_replication/output/HBN/BNC/GAM/fits.SAaxis.posteriorcorrs_BNC.RData")

#fits.SAaxis.posteriorcorrs_WNC <- lapply(atlases, load_posterior_deriv, "WNC")
#names(fits.SAaxis.posteriorcorrs_WNC) <- atlases 
#saveRDS(fits.SAaxis.posteriorcorrs_WNC, "/cbica/projects/network_replication/output/HBN/WNC/GAM/fits.SAaxis.posteriorcorrs_WNC.RData")
...
fits.SAaxis.posteriorcorrs_GBC <- readRDS("/cbica/projects/network_replication/output/HBN/GBC/GAM/fits.SAaxis.posteriorcorrs_GBC.RData") 

#fits.SAaxis.posteriorcorrs_BNC <- readRDS("/cbica/projects/network_replication/output/HBN/BNC/GAM/fits.SAaxis.posteriorcorrs_BNC.RData")  

#fits.SAaxis.posteriorcorrs_WNC <- readRDS("/cbica/projects/network_replication/output/HBN/WNC/GAM/fits.SAaxis.posteriorcorrs_WNC.RData" ) 
...
saveRDS(cor.credible.intervals_GBC, "/cbica/projects/network_replication/output/HBN/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
...
#saveRDS(cor.credible.intervals_BNC, "/cbica/projects/network_replication/output/HBN/BNC/GAM/cor.credible.intervals_BNC_fitted.RData")

 

#cor.credible.intervals_WNC <- lapply(atlases, function_cor.credible.intervals, "WNC")
#names(cor.credible.intervals_WNC) <- atlases
#saveRDS(cor.credible.intervals_WNC, "/cbica/projects/network_replication/output/HBN/WNC/GAM/cor.credible.intervals_WNC_fitted.RData")

```

 
```{r load_cor.credible.intervals, include=FALSE}
cor.credible.intervals_GBC <- readRDS("/cbica/projects/network_replication/output/HBN/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
 
#cor.credible.intervals_BNC <- readRDS("/cbica/projects/network_replication/output/HBN/BNC/GAM/cor.credible.intervals_BNC.fitted.RData")

#cor.credible.intervals_WNC <- readRDS("/cbica/projects/network_replication/output/HBN/WNC/GAM/cor.credible.intervals_WNC.fitted.RData")
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig7/Fig7_HBN_GBC_ageFittedValues.pdf", dpi=300, width = 6, height = 5)
```
