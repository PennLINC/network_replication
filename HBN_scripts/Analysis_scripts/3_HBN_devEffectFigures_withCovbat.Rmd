...
Makes Figures 2D, 2H, 2L, 2P, 4D, 5D, 5H
...
#### Plot Figure 2D: GBC Dev Trajectory  
...
spearman_rho <- data.frame(cbind(corr.BNC_gordon, corr.BNC_schaefer200x7, corr.BNC_schaefer400x7, corr.BNC_schaefer200x17, corr.BNC_schaefer400x17, corr.WNC_gordon, corr.WNC_schaefer200x7, corr.WNC_schaefer400x7, corr.WNC_schaefer200x17, corr.WNC_schaefer400x17))
...
saveRDS(list(p_spin_BNC, p_spin_WNC), "/cbica/projects/network_replication/output/HBN/pspin_vals_covbat.RData")
```
