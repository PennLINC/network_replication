...
Makes Figures 3D, 3H, 3L, 3P, 4D, 5D, 6D, 6H
...
for(i in c(1:length(atlases_GBC))){
  ...
  assign(df_name, make_gam.smooths_centered_covbat(metric, atlases_GBC[i], dataset))  
  print(df_name)
} 
```
...
#### Plot Figure 3D: GBC Dev Trajectory  
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTraj_HBN.pdf", dpi=1200, width = 5, height = 5)
```
...
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_SM_HBN.pdf", dpi=1200, width = 5, height = 5)

schaefer200x7_attention 
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_Attention_HBN.pdf", dpi=1200, width = 5, height = 5)

schaefer200x7_default 
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig3/Fig3_GBCDevTrajRep_Default_HBN.pdf", dpi=1200, width = 5, height = 5)
...
#GBC
r_text_GBC.glasser <- expression(paste(italic("r"), " = -0.77, ",  , italic(p[spin]), "< 0.0001")) 
...
r_text_GBC.gordon <- expression(paste(italic("r"), "= -0.70, ",  , italic(p[spin]), "< 0.0001"))
...
(BNC_gordon <- gam_figure_p.spin(BNC.axis_gordon, "BNC", "Gordon", r_text_BNC.gordon, 
                                  x_pos= 270, y_pos=0.1, ylim_lower=-0.07, ylim_upper=0.10))

r_text_BNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.70, ",  , italic(p[spin]), "< 0.001"))
(BNC_schaefer200x7 <- gam_figure_p.spin(BNC.axis_schaefer200x7, "BNC", "schaefer200x7", r_text_BNC.schaefer200x7, 
                                  x_pos= 150, y_pos=0.1, ylim_lower=-0.085, ylim_upper=0.10))

r_text_BNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.73, ",  , italic(p[spin]), "< 0.0001"))
...
#WNC
r_text_WNC.gordon <- expression(paste(italic("r"), "= -0.16, ",  , italic(p[spin]), "= N.S"))
...
r_text_WNC.schaefer200x7 <- expression(paste(italic("r"), "= -0.37, ",  , italic(p[spin]), "< 0.001"))
(WNC_schaefer200x7 <- gam_figure_p.spin(WNC.axis_schaefer200x7, "WNC", "schaefer200x7", r_text_WNC.schaefer200x7, 
                                 x_pos= 150, y_pos=0.15, ylim_lower=-0.055, ylim_upper=0.17))

r_text_WNC.schaefer200x17 <- expression(paste(italic("r"), "= -0.28, ",  , italic(p[spin]), "< 0.01"))
...
r_text_WNC.schaefer400x7 <- expression(paste(italic("r"), "= -0.31, ",  , italic(p[spin]), "< 0.001"))
...
GBC_schaefer200
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig4/Fig4_GBCAgeEffect_HBN_Covbat.pdf", dpi=300, width = 5, height = 5)
```

## **Figure 5D**
#### load GAM fitted values
```{r load_gam.fitted, include=FALSE, cache=TRUE}
gam.GBC.fitted.schaefer200 <- read.csv(sprintf("/cbica/projects/network_replication/output/%1$s/%2$s/GAM/%3$s_covbat.csv", dataset, "GBC", "gam.GBC.fitted.schaefer200"))
```
...
fits.SAaxis.posteriorcorrs_GBC <- readRDS(sprintf("/cbica/projects/network_replication/output/%1$s/%2$s/GAM/SAaxis_posteriorfits_correlation_byage_%3$s_covbat.RData", dataset, "GBC", "schaefer200"))
...
saveRDS(cor.credible.intervals, "/cbica/projects/network_replication/output/HBN/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
  
```

 
```{r load_cor.credible.intervals, include=FALSE}
cor.credible.intervals <- readRDS("/cbica/projects/network_replication/output/HBN/GBC/GAM/cor.credible.intervals_GBC_fitted.RData")
```
...
SA_metric_corr_GBC 
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig5/Fig5_HBN_GBC_ageFittedValues.pdf", dpi=1200, width = 5, height = 5)
```


#### **Figure 6D** 
#### Plot Figure 6D: BNC DevEffect  
```{r Fig2, fig.height= 8, fig.width= 16, warning=FALSE, cache=TRUE}
BNC_schaefer200x7
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig6/Fig6_BNCAgeEffect_HBN_covbat.pdf", dpi=300, width = 6, height = 5)
```

#### **Figure 6H**
#### Plot Figure 6H: BNC DevEffect  
```{r Fig3, fig.height= 8, fig.width= 16, warning=FALSE, cache=TRUE}
WNC_schaefer200x7
ggsave("/Users/audluo/Library/CloudStorage/Box-Box/Box_PhD_Land/PennLINC/network_replication/Writing/Manuscript/Figures/Figures_Illustrator/Fig6/Fig6_WNCAgeEffect_HBN_covbat.pdf", dpi=300, width = 6, height = 5)
```
