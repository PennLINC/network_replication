...
listCifti <- function(subject, list_filepath, ciftiFiles_df){
  ...
  saveRDS(cifti_list, paste0("/cbica/projects/network_replication/input/HBN/connMatricesData/cifti_lists/", subject, "_timeseriesTaskandRest.RData"))
  ...
  saveRDS(matrix_output, paste0("/cbica/projects/network_replication/input/HBN/connMatricesData/connectivity_matrices/", subject,"_ConnMatrices.RData"))
  rm(cifti_list)
  rm(matrix_output)
  gc()
}
